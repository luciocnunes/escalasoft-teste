object frmSaque: TfrmSaque
  ...
  Caption = 'Caixa Eletr'#243'nico - Saque'
  ClientHeight = 440
  ClientWidth = 440
  Color = clBtnFace
  ...
  OnShow = FormShow
  TextHeight = 17
  object GroupBoxAutenticacao: TGroupBox
    Left = 16
    Top = 16
    Width = 408
    Height = 134
    ...
    Margins.Right = 5
    Margins.Bottom = 5
    Caption = ' 1. Identifica'#231#227'o do Cliente '
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -13
    Font.Name = 'Segoe UI'
  ...
  object GroupBoxOperacao: TGroupBox
    Left = 14
    Top = 162
    Width = 408
    Height = 280
    Caption = ' 2. Solicita'#231#227'o de Saque '
    Enabled = False
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -13
    ...
    object RGEstrategia: TRadioGroup
      Left = 196
      Top = 6
      Width = 197
      Height = 47
